...
\smallbreak
{{\fontseries{sb}\selectfont Skills:} Python 3, C, C++, MySQL, \LaTeX, Ruby, Rust, Java, asynchronous programming, Bash, Git, Mercurial, Docker, Docker Compose, AWS, Node.js, Thrift, RPC, stateless services, networking}
